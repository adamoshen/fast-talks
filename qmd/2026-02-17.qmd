...
3. I've been eating a lot of 🐔 chicken and 🥬 leafy salads 🥗 lately, and I want something with a
different flavour profile.

4. 💪🏼 I'm trying to hit my daily protein goals while also making sure that I'm not going too
...
to the gym 🏋🏼‍♂️ later in the evening. 
...
Domino's where the crust is super thick and dense 😒)

3. Their items are reasonably priced 🫰🏼 for the amount of food you get and there are often
discounts on the app or on social media 🤑.

4. Leftovers reheat well so you can eat it again tomorrow 🤤. See
...
1. Of their "core" pizza offerings, which pizza is the 👍🏼💰 most cost effective while having the
⬇️🫃🏼 least calories and the ⬆️💪🏼 most protein?
...
(after the Fairlife Shake). I'm not really a fan of the BBQ Chicken pizza though 🫤.
...
Rather than looking at price per gram of protein, it probably would have been better to look at the
price per 30g of protein to get an idea of how much you would be paying for pizza compared to a
bottle of the Fairlife protein shake.
...
```{r large_pizzas2_discount, eval=FALSE}
...
```{r large_pizzas2_discount, echo=FALSE}
```
